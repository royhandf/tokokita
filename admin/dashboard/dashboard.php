                ...
                <div class="col-md-12 mt-4">
                    <div class="card shadow p-4">
                            ...
                            <p class="mt-4">
                                ...
                                <br>
                                Pada halaman dashboard, Anda dapat mengelola kategori, produk, order, dan lainnya
                            </p>
                            <img src="../../assets/dashboard.png" alt="dashboard" class="w-75">
                        </div>
                    </div>
                    <div class="row justify-content-evenly mt-4">
                        <div class="col-md-4 mb-3">
                            <div class="card shadow p-3">
                                <div class="row text-center">
                                    <div class="col-md-6">
                                        <img src="../../assets/customer.png" alt="icon" width="105">
                                    </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card shadow p-3">
                                <div class="row text-center">
                                    <div class="col-md-6">
                                        <img src="../../assets/products.png" alt="icon" width="100">
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <div class="row">
                                            <div class="col-md-12">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card shadow p-3">
                                <div class="row text-center">
                                    <div class="col-md-6">
                                        <img src="../../assets/orders.png" alt="icon" width="105">
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <div class="row">
                                            <div class="col-md-12">
